      ...
      <div className="w-full h-full flex p-10 px-50 py-50 bg-orange-100">
        <div className="flex flex-col items-center">
          ...
          <p className="p-10 leading-30  text-justify text-red-900 font-serif font-semibold">
            ನಮ್ಮ ತುಳುನಾಡು ಸತ್ಯ, ನ್ಯಾಯ, ಧರ್ಮಕ್ಕೆ ಪ್ರಸಿದ್ಧಿ ಪಡೆದ ಪುಣ್ಯಭೂಮಿ. ಇಲ್ಲಿನ
            ಸಂಸ್ಕೃತಿ, ಆಚಾರ ವಿಚಾರಗಳು, ಆರಾಧನಾ ಪದ್ಧತಿಗಳು ಜಗತ್ತಿನೆಲ್ಲೆಡೆ ಪ್ರಖ್ಯಾತಿ
            ಪಡೆದಿರುವುದು ತುಳುನಾಡಿನ ಹೆಮ್ಮೆ, ಈ ನೆಲದ ಸಂಸ್ಕೃತಿಯನ್ನು ಉಳಿಸುವಲ್ಲಿ ಇಲ್ಲಿನ
            ಆರಾಧನಾಲಯಗಳ ಕೊಡುಗೆಯು ಅಪಾರವಾದುದು, ತುಳುನಾಡಿನ ಪುಣ್ಯಕ್ಷೇತ್ರಗಳಲ್ಲಿ
            ಕಾಲಕಾಲಕ್ಕೆ ನಡೆಯುವ ಪೂಜೆ, ಉತ್ಸವಾದಿಗಳು ಮಾನವ ಕುಲದ ಬದುಕಿಗೆ ಶಾಂತಿ,
            ನೆಮ್ಮದಿಯನ್ನು ನೀಡುವುದರೊಂದಿಗೆ ಸಮಾಜ ಸತ್ಪಥದಲ್ಲಿ ಮುನ್ನಡೆಯಲು
            ಪ್ರೇರಣೆಯಾದುದು. ಅದೆಷ್ಟೋ ಹಳೆಯ ಆರಾಧನಾಲಯಗಳ ಜೀರ್ಣೋದ್ಧಾರ, ಹೊಸ ಕ್ಷೇತ್ರಗಳ
            ನಿರ್ಮಾಣ, ವೈಭವಯುತ ಉತ್ಸವಗಳು ಮತ್ತೆ ಮತ್ತೆ ನಡೆಯುತ್ತಾ ತುಳುನಾಡಿನ
