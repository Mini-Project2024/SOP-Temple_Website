...
const ContactPage = ({ id }) => {
  return (
    <div className='flex flex-row bg-orange-100 w-full h-screen' id={id}>

    <div className='left px-50 py-50 h-full w-full'>
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-red-900">Contact Us</h2>
      ...
      <form action="#" className="space-y-8">
          ...
          <div>
              <label htmlFor="subject" className="block mb-2 text-sm font-medium text-red-900">Subject</label>
          ...
          <div className="sm:col-span-2">
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-red-900">Your message</label>
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-red-900 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
